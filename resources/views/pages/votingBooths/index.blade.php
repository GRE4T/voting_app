...
@section('main-content')
    <div class="breadcrumb">
        <ul class="d-flex align-items-center">
            ...
            <li class="h3 bold">Modulo de puestos de votación</li>
        </ul>
    </div>
    <div class="row mb-2">
        <div class="col text-right">
            <a class="btn btn-success" href="{{ route('voting-booths.create')}}">Añadir nuevo</a>
        </div>
    </div>
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive-md">
                <table id="table_booths" class="table table-borderless table-hover">
                    <thead>
                    <tr>
                        <th scope="col">#</th>
                        <th scope="col">Nombre o lugar</th>
            ...
            table = $('#table_booths').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render(data) {
                            return `
                    <a href="{{ url('voting-booths') }}/${data}/edit" class="text-success mr-2">
        ...
        function deleteElement(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.delete("{{ url('api/voting-booths') }}/" + id, null)
                        .then((res) => {
                            Swal.fire(
                                '¡Eliminado!',
