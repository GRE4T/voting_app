...
return [
    ...
    'attributes'           => [
        ...
        'filters' => 'filtros',
        'today' => 'hoy',
        'number_tables' => 'número de mesas',
        'number_candidates' => 'número de candidatos',
        'voting_booth_id' => 'puesto de votación',
        'number_table' => 'número de mesa',
        'user_id' => 'usuario',
        'record_id' => 'registro',
        'party_id' => 'partido',
        'number_candidate' => 'número de candidato',
        'votes' => 'votos'
